...
export default function BoronHeader() {
  ...
  return (
    <StickyHeader className="fixed start-0 top-0 z-[990] w-full bg-primary dark:bg-gray-100/50 dark:backdrop-blur-3xl 3xl:px-8">
      <div className="flex w-full max-w-2xl items-center">
        ...
        <div className="hidden w-[270px] xl:inline-block 2xl:w-72">
          ...
          >
           <div className='text-white'>XCO3</div>
